...
INSERT INTO `friend_requests` VALUES (1,2,1,'2017-09-27 06:47:53'),(1,3,1,'1986-10-02 19:43:55'),(1,4,3,'2003-11-21 07:52:52'),
(1,5,1,'2009-01-14 22:39:17'),(1,6,2,'1978-06-12 11:51:02'),(1,7,1,'1975-07-31 10:07:37'),(1,11,1,'2011-10-20 03:41:20'),(2,3,3,'1978-04-07 14:52:47'),
(2,4,3,'2015-11-22 04:15:34'),(2,5,1,'1987-03-12 21:23:21'),(2,10,2,'2018-11-29 10:14:17'),(2,11,2,'1985-09-24 08:33:11'),(3,4,1,'2008-06-14 03:33:41'),
(3,5,1,'1997-12-22 14:39:38'),(3,6,1,'2007-09-16 21:37:23'),(3,7,1,'2013-03-18 07:19:43'),(3,10,2,'2004-10-05 19:43:07'),(3,11,1,'2003-12-06 09:45:56'),
(4,5,1,'1990-05-10 07:14:37'),(5,1,1,'2010-01-14 22:39:17'),(5,6,1,'1991-01-06 03:31:10'),(5,7,1,'1995-11-01 23:52:03'),(6,7,1,'1989-10-24 05:07:37'),
(6,8,1,'1978-09-09 02:38:33'),(6,9,3,'1984-12-29 22:38:10'),(6,11,2,'1991-09-18 02:01:46'),(7,8,2,'1975-09-13 16:30:31'),
(7,9,1,'2005-01-17 01:24:22'),(7,11,1,'1997-04-29 02:59:17'),(8,5,1,'1976-02-13 03:28:05'),(8,10,2,'1971-06-04 08:18:54'),(9,8,3,'1990-03-15 09:58:18'),
(9,10,1,'1982-03-22 05:09:28'),(10,5,1,'1971-06-18 06:46:58'),(10,4,1,'2012-02-04 06:36:36'),(10,11,3,'1981-02-10 08:41:17'),(11,5,3,'2010-04-29 11:07:45'),
(11,6,2,'1990-02-23 05:16:15'),(11,9,3,'1989-03-03 07:49:54');
...
SELECT
  id,
  (SELECT COUNT(user_id) FROM posts_likes WHERE user_id = users.id) AS likes,
  ...
  -- total
  ((SELECT COUNT(user_id) FROM posts_likes WHERE user_id = users.id) +
  (SELECT COUNT(id) FROM posts WHERE user_id = users.id) + 
  (SELECT COUNT(id) FROM media WHERE user_id = users.id) +
  (SELECT COUNT(id) FROM messages WHERE from_user_id = users.id)) as total
FROM users 
